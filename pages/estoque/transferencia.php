          ...
          >
            ...
            >
              <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                  <a href="item.php" class="nav-link text-white"
                    ><i class="fa fa-dropbox" aria-hidden="true"></i> Cadastrar
                    Item</a
                  >
                </li>
                <li>
                  <a href="transferencia.php" class="nav-link text-white active"
          ...
          <div class="row">
            ...
            <div class="col w-100 mx-2 mt-2">
              ...
              <form>
                ...
                <div class="mb-3">
                  <label for="transacao" class="form-label"
                ...
                <div class="mb-3">
                  <label for="descricao" class="form-label"
                    >Descrição da Transferência</label
                  >
                  <textarea
                    class="form-control"
                    id="descrica"
