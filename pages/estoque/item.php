...
<html lang="pt-br">
  ...
  <body>
    <nav class="navbar navbar-expand-md bg-primary navbar-dark shadow">
      <a class="navbar-brand ml-5 px-3" href="#">
        Estoque <i class="fa fa-angellist" aria-hidden="true"></i
      ></a>
      <button
          ...
          >
            ...
            >
              <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                  <a href="./item.php" class="nav-link text-white active"
                    ><i class="fa fa-dropbox" aria-hidden="true"></i> Cadastrar
                    Item</a
                  >
                </li>
                <li>
                  <a href="./transferencia.php" class="nav-link text-white"
                ...
                <li>
                  <a href="./itens.php" class="nav-link text-white"
                    ><i class="fa fa-list-alt" aria-hidden="true"></i> Itens</a
                  >
                </li>
                <li>
                  <a href="./movimentacoes.php" class="nav-link text-white"
              ...
              <form>
                <div class="row">
                  <div class="mb-3 col-6">
                    ...
                    <select class="form-select form-control" name="deposito" id="deposito">
                      <option selected>--------</option>
                      <option value="1">Despósito 1</option>
                      <option value="2">Despósito 2</option>
                    </select>
                  </div>
                  <div class="mb-3 col-6">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select form-control" name="unidade" id="unidade">
                    <option selected>--------</option>
